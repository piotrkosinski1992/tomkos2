...
import static com.tomkos2.monolith.app.user.config.jwt.JwtProperties.TOKEN_HEADER;
import static com.tomkos2.monolith.app.user.config.jwt.JwtProperties.TOKEN_PREFIX;

import com.tomkos2.monolith.app.user.config.UserPrincipalDetailsService;
